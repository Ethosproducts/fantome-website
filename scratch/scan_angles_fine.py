...
if __name__ == "__main__":
    ...
    # Fine angles for Original
    orig_angles = [45, 50, 55, 60, 65, 70, 75, 80]
    # Fine angles for Sugar Free
    sf_angles = [180, 195, 210, 225, 240, 255, 270]
    
    print("STARTING ORIGINAL FLAVOR FINE SWEEP...", flush=True)
    ...
    print("STARTING SUGAR FREE FLAVOR FINE SWEEP...", flush=True)
    ...
    print("FINE SWEEP COMPLETE!", flush=True)
