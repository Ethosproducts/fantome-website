...
output_path = "public/mojito_texture.png"

# Bounding box coordinates with a 2-pixel margin to avoid background white bleed
Y_START = 80
Y_END = 600
LABEL_HEIGHT = Y_END - Y_START

X_CENTER = 511.5
RADIUS = 104.0  # Slightly reduced from 106.5 to prevent sampling background pixels at edges
...
def main():
    ...
    print("Generating 2048x2048 HD cylinder texture using vectorized math with curvature correction...")
    for view in views:
        ...
        # This keeps the sampling area strictly within the printed black/green label boundaries.
    ...
    output_arr[~valid] = [30.0, 40.0, 35.0]
    ...
    print("HD Texture generated successfully!")
