...
function ShopSection({ activeColor }) {
  ...
  const crateFlavors = [
    { name: "Mojito", color: "#059669", graphic: "/mojito_straight.png?v=6" },
    { name: "Original", color: "#DC2626", graphic: "/original_straight.png?v=6" },
    { name: "Sugar Free", color: "#475569", graphic: "/sugarfree_straight.png?v=6" }
  ];
...
function App() {
  ...
  const flavors = [
    { 
      ...
      canFront: "/mojito_straight.png?v=6"
    },
    { 
      title: "Original", 
      flavor: "Unseen Power", 
      ...
      canFront: "/original_straight.png?v=6"
    },
    { 
      title: "Sugar Free", 
      ...
      canFront: "/sugarfree_straight.png?v=6"
    }
  ];
