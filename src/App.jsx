...
function ShopSection({ activeColor }) {
  ...
  const crateFlavors = [
    { name: "Mojito", color: "#059669", graphic: "/mojito_straight.png" },
    { name: "Original", color: "#DC2626", graphic: "/original_straight.png" },
    { name: "Sugar Free", color: "#475569", graphic: "/sugarfree_straight.png" }
  ];
...
function App() {
  ...
  const flavors = [
    ...
    { 
      ...
      canFront: "/original_straight.png"
    },
    { 
      title: "Sugar Free", 
      ...
      canFront: "/sugarfree_straight.png"
    }
  ];
